...
import can1 from "../assets/modi.jpg";
import can2 from "../assets/rahul.jpg";

const PollingStation = (props) => {
  const [candidate1URL, changeCandidate1Url] = useState(can1);
  const [candidate2URL, changeCandidate2Url] = useState(can2);
    ...
    const getInfo = async () => {
     ...
     /* changeCandidate1Url(
        await window.contract.getUrl({
          name:localStorage.getItem("Candidate1URL"),
        })
      );
      changeCandidate2Url(
        await window.contract.getUrl({
          name:localStorage.getItem("Candidate2URL"),
        })
      );
      */
